...
class AddProperty extends Component {
  ...
  handleSubmit = (event) => {
    ...
    const predict = window.web3.utils.toWei(
      this.state.prediction.toString(),
      "Ether"
    );
          ...
          <form>
            ...
            <div class="user-box">
              {this.state.prediction && (
                <label>
                  Fair Market Value (in ETH): {this.state.prediction}
                </label>
              )}
            </div>

            <button className=".btn1" onClick={this.handlePrediction}>
              <span></span>
              <span></span>
              <span></span>
              <span></span>Predict
            ...
            <button className=".btn2" onClick={this.handleSubmit}>
              <span></span>
              <span></span>
              <span></span>
              <span></span>Submit
